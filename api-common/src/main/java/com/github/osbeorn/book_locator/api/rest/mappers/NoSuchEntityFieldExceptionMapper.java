...
@Provider
@ApplicationScoped
public class NoSuchEntityFieldExceptionMapper implements ExceptionMapper<NoSuchEntityFieldException> {
    ...
    public Response toResponse(NoSuchEntityFieldException exception) {
        ...
        error.setMessage(i18n.getString("resource.no.field", exception.getEntity(), exception.getField()));
